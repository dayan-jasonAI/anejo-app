...
const proposal={product_ids:['catering-lechon'],assumptions:['Audience interest is proposed, not measured.'],questions:['Confirm event availability.'],channels:['instagram'],assets:['Full-frame tray photo required.']};
const brief={id:'tb1',status:'draft',title:'Catering',objective:'x'.repeat(180),audience:'Local hosts',angle:'Premium presentation',promotion_id:'p1',review_scope:'team_planning_only',promotion_proposal_json:JSON.stringify(proposal)};
