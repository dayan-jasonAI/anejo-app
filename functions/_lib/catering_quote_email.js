...
const COPY = {
  en: {
    ...
    modifyBody: 'Tell us what to adjust — quantities, an extra dish, or your guest count. We will send you an updated quote. Nothing is charged when you send it.',
  ...
  es: {
    ...
    modifyBody: 'Escríbanos qué desea ajustar — cantidades, un plato más, o el número de invitados. Le enviaremos una cotización actualizada. No se cobra nada al enviarlo.',
