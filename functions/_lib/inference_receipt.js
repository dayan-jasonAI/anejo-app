...
const COMPONENTS = new Set(['brand', 'training', 'menu', 'briefs', 'intel', 'knowledge', 'operations', 'performance', 'retrospective', 'history', 'product_lines']);
const FIELDS = new Set(['schema', 'source', 'read_status', 'reads', 'rendered_sha256', 'original_chars', 'supplied_chars', 'truncated', 'rules', 'examples', 'documents', 'source_ids', 'id', 'updated_at', 'selection_limit', 'selection_may_be_limited', 'requested_sections', 'section_fallback', 'fallback_reason']);
