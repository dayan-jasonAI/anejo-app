...
## Later September 26 observations

Audit v12, voice error fallback and no-contact confirmation repairs are deployed per RELEASE_EVIDENCE; earlier candidate statuses above are historical. Further normal-browser cart check: zero taco quantities disabled Add; one lechón selection showed $10, reopening edit retained chicken0/lechón1, adding chicken produced two distinct $10 lines and $20 subtotal. Switching English to Spanish preserved both variants and subtotal/minimum notice. Both temporary lines were removed through UI; empty cart observed and original Spanish preference restored. No personal details, checkout submission or customer communications.
